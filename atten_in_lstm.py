...
from keras.layers import Dense, Input, LSTM, Embedding, Dropout, Activation, GlobalAveragePooling1D, TimeDistributed, Flatten
...
def own_model(train_forward_data, train_backward_data, train_sense_embedding, 
              ...
              n_units=100, dense_unints=256, is_training=True, EMBEDDING_DIM=100, epochs=25, batch_size=2048, init_word_vecs=None):
    ...
    merged = Dropout(0.3)(merged) if is_training else merged
